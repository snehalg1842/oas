 ...
 *  
 */
package com.born.thor.oas.jalo;
...
import com.born.thor.oas.constants.OasConstants;



/**
 * This is the extension manager of the Oas extension.
 */
public class OasManager extends GeneratedOasManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = Logger.getLogger(OasManager.class.getName());
	 ...
	 */
	public static OasManager getInstance()
	{
		return (OasManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager().getExtension(
				OasConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public OasManager() // NOPMD 
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of OasManager called.");
		}
	}
	...
	public void init()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("init() of OasManager called. " + getTenant().getTenantID());
		}
	}
	...
	public void destroy()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("destroy() of OasManager called, current tenant: " + getTenant().getTenantID());
		}
	}
